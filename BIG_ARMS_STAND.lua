...
-----------------------------------
Made by ? / Modified by Windows7King
------------------------------------

Modification: Changed head tp hair from loubu game to look more like jojo and
made the arms thicker with the accessories from givenchy.



So this is the list of hats you need to be wearing (they are all free to get) :
https://www.roblox.com/catalog/451220849/Lavender-Updo
https://www.roblox.com/catalog/9867551444/Irresistible-Backpack-3-0
...
https://www.roblox.com/catalog/9867554787/Irresistible-backpack-1-0
https://www.roblox.com/catalog/62724852/Chestnut-Bun (this one is in a bundle) - https://www.roblox.com/bundles/239/Woman
https://www.roblox.com/catalog/7548992599/Grey-Hair
...
local Head = "Hair_AccAccessory" --press f9 and find the hat that looks like a heads name and put it here
local x = -2   --Edit Position for head
local y = 3   --Edit Position for head x2
local z = 3 --Edit Position for head x3


local Hats = {rightarm = Character:WaitForChild("PerfumeBag_3.0"),
             leftarm  = Character:WaitForChild("Robloxclassicred"),
             rightleg = Character:WaitForChild("LavanderHair"),
             leftleg  = Character:WaitForChild("Pink Hair"),
             torso2   = Character:WaitForChild("PerfumeBag_1.0"),
             torso1   = Character:WaitForChild("Kate Hair"),
